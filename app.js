// RAGAS v6.0.0 application UI logic — extracted for maintainability
...
function applyRoleUi(){
  ...
  const badge=$('userRoleBadge');if(badge){badge.textContent=`${currentUser?.username||''} · ${roleLabel()}`;badge.title=currentUser?.fullName||currentUser?.username||''}
